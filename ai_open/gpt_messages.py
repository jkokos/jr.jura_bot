...
class GPTMessage:
    ...
    def __init__(self, prompt: str, message_list:list[dict[str, str]] | None=None):
        ...
        self.message_list =message_list if message_list else self._unit_message

    def _init_message(self) -> list[dict[str, str]]:     # inicializacija
        message = {
